...
<style>
  ...
  <div class="row">
    <div class="col-12">
      <a href="{{ url('/tambahuser') }}" class="btn btn-primary btn-md" role="button">Tambah</a>
      <p></p>
      <div>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" id="dropdown-action-id">
                        <a class="dropdown-item" href="ubahuser/{{$data->id}}">Ubah Data</a>
                        <a class="dropdown-item swalDelete" href="hapususer/{{$data->id}}">Hapus Data</a>
                      </div>
                    </div>
                  </td>
               </tr>
